[![Java CI with Gradle](https://github.com/Larinatest/BDD/actions/workflows/gradle.yml/badge.svg)](https://github.com/Larinatest/BDD/actions/workflows/gradle.yml)
